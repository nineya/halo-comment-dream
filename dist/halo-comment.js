...
if (typeof window !== 'undefined') {
  ...
  if (({"NODE_ENV":"production","BASE_URL":"https://unpkg.com/halo-comment-dream@1.0.5/dist/"}).NEED_CURRENTSCRIPT_POLYFILL) {
...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/Comment.vue?vue&type=template&id=451f498a&shadow
...
/* harmony default export */ var DreamEmojivue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    url: {
      type: String,
      required: false,
      default: `${"https://unpkg.com/halo-comment-dream@1.0.5/dist/"}assets/emoji/`
    }
  },
  computed: {
    dreamSrc() {
...
function renderedEmojiHtml(html) {
  ...
  for (let emoji of emojiData) {
    let name = emoji.name;
    let img = `<img class="dream-emoji" src="${"https://unpkg.com/halo-comment-dream@1.0.5/dist/"}assets/emoji/${emoji.fileName}.png" alt="${name}"/>`;
...
var CommentEditor_component = normalizeComponent(
  ...
  CommentEditorvue_type_template_id_33b677a2_render,
  CommentEditorvue_type_template_id_33b677a2_staticRenderFns,
  false,
  null,
  null,
  null
