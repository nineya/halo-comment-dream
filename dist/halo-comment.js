...
if (typeof window !== 'undefined') {
  ...
  if (({"NODE_ENV":"production","BASE_URL":"https://unpkg.com/halo-comment-dream@1.0.4/dist/"}).NEED_CURRENTSCRIPT_POLYFILL) {
...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/Comment.vue?vue&type=template&id=55825b3e&shadow
...
/* harmony default export */ var DreamEmojivue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    url: {
      type: String,
      required: false,
      default: `${"https://unpkg.com/halo-comment-dream@1.0.4/dist/"}assets/emoji/`
    }
  },
  computed: {
    dreamSrc() {
...
function renderedEmojiHtml(html) {
  ...
  for (let emoji of emojiData) {
    let name = emoji.name;
    let img = `<img class="dream-emoji" src="${"https://unpkg.com/halo-comment-dream@1.0.4/dist/"}assets/emoji/${emoji.fileName}.png" alt="${name}"/>`;
  ...
  methods: {
    ...
    handleImageUpload() {
      ...
      fileElem.addEventListener('change', () => {
        ...
        formData.append('key', 'a8150b7fe6b41ad4d44d136f95bf4dbe');
        ...
        fetch('https://api.imgbb.com/1/upload', {
          ...
          this.comment.content += `![${image.name}](${image.url})`;
...
var CommentEditor_component = normalizeComponent(
  ...
  CommentEditorvue_type_template_id_034277c4_render,
  CommentEditorvue_type_template_id_034277c4_staticRenderFns,
  false,
  null,
  null,
  null
...
var CommentNode_component = normalizeComponent(
  ...
  CommentNodevue_type_template_id_3f5aedba_render,
  CommentNodevue_type_template_id_3f5aedba_staticRenderFns,
  false,
  null,
  null,
  null
