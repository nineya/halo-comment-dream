...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".comment-page{margin-top:30px;text-align:center;border-top:2px solid var(--bg-b)}.comment-page .page{display:inline-block;padding:10px 0;margin:0}.comment-page .page li{display:inline;margin-right:5px}.comment-page .page button{margin-bottom:8px;position:relative;font-size:inherit;font-family:inherit;padding:5px 10px;border:1px solid var(--color-a);border-radius:4px;cursor:pointer;-webkit-transition:all .8s;transition:all .8s;font-weight:400;color:var(--color-f);background-color:var(--bg-a)}.comment-page .page .active,.comment-page .page button:hover{color:var(--comment-theme);border-color:var(--comment-theme)}", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
var component = normalizeComponent(
  ...
  CommentEditorvue_type_template_id_516ee206_render,
  CommentEditorvue_type_template_id_516ee206_staticRenderFns,
  false,
  null,
  null,
  null
...
var CommentNode_component = normalizeComponent(
  ...
  CommentNodevue_type_template_id_df0890b8_render,
  CommentNodevue_type_template_id_df0890b8_staticRenderFns,
  false,
  null,
  null,
  null
...
var Pagination_component = normalizeComponent(
  ...
  Paginationvue_type_template_id_96b5ff14_render,
  Paginationvue_type_template_id_96b5ff14_staticRenderFns,
  false,
