...
if (typeof window !== 'undefined') {
  ...
  if (({"NODE_ENV":"production","BASE_URL":"/themes/dream/source/lib/halo-comment@1.0.9/"}).NEED_CURRENTSCRIPT_POLYFILL) {
...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/Comment.vue?vue&type=template&id=3838ba95&shadow
...
/* harmony default export */ var DreamEmojivue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    url: {
      type: String,
      required: false,
      default: `${"/themes/dream/source/lib/halo-comment@1.0.9/"}assets/emoji/`
    }
  },
  computed: {
    dreamSrc() {
...
function renderedEmojiHtml(html) {
  ...
  for (let emoji of emojiData) {
    let name = emoji.name;
    let img = `<img class="dream-emoji" src="${"/themes/dream/source/lib/halo-comment@1.0.9/"}assets/emoji/${emoji.fileName}.png" alt="${name}"/>`;
...
var CommentNode_component = normalizeComponent(
  ...
  CommentNodevue_type_template_id_63b8a751_render,
  CommentNodevue_type_template_id_63b8a751_staticRenderFns,
  false,
  null,
  null,
  null
