...
var component = normalizeComponent(
  ...
  CommentEditorvue_type_template_id_4868203f_render,
  CommentEditorvue_type_template_id_4868203f_staticRenderFns,
  false,
  null,
  null,
  null
...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/CommentNode.vue?vue&type=template&id=ed60e426&
var CommentNodevue_type_template_id_ed60e426_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"comment",class:_vm.commentClass,attrs:{"id":'li-comment-' + _vm.comment.id,"itemprop":"comment","itemtype":"https://schema.org/Comment"}},[_c('div',{ref:'comment-' + _vm.comment.id,staticClass:"comment-body",attrs:{"id":'comment-' + _vm.comment.id}},[_c('div',{staticClass:"avatar-body"},[_c('a',{attrs:{"href":("" + (_vm.comment.authorUrl ? _vm.comment.authorUrl : 'javascript:void(0)')),"rel":"nofollow","target":"_blank"}},[_c('img',{staticClass:"avatar",attrs:{"alt":_vm.comment.author + "'s avatar","src":_vm.avatar}})])]),_c('div',{staticClass:"comment-main"},[_c('div',{staticClass:"comment-meta"},[_c('div',{staticClass:"comment-author",attrs:{"itemprop":"author"}},[_c('div',{staticClass:"author-info"},[_c('a',{staticClass:"author-name",attrs:{"href":_vm.comment.authorUrl,"rel":"nofollow","target":"_blank"}},[_vm._v(_vm._s(_vm.comment.author))]),(_vm.comment.isAdmin)?_c('span',{staticClass:"is-admin"},[_vm._v("博主")]):_vm._e()]),_c('span',{staticClass:"btn btn-primary comment-reply",on:{"click":function($event){_vm.editing = !_vm.editing}}},[_vm._v(_vm._s(_vm.editing ? '取消回复' : '回复'))])]),_c('div',{staticClass:"comment-info"},[_c('time',{staticClass:"comment-time",attrs:{"datetime":_vm.comment.createTime,"itemprop":"datePublished"}},[_vm._v(_vm._s(_vm.createTimeAgo))]),(_vm.configs.showUserAgent)?_c('div',{staticClass:"useragent-info"},[_vm._v(" "+_vm._s(_vm.compileUserAgent)+" ")]):_vm._e()])]),_c('div',{staticClass:"markdown-body",attrs:{"itemprop":"description"}},[(_vm.parent)?_c('span',{domProps:{"innerHTML":_vm._s(_vm.compileReference)},on:{"mouseenter":_vm.handleHighlightParent,"mouseleave":function($event){return _vm.handleHighlightParent(false)}}}):_vm._e(),_c('div',{staticClass:"markdown-content"},[(_vm.parent)?_c('span',{domProps:{"innerHTML":_vm._s(_vm.compileReference)},on:{"mouseenter":_vm.handleHighlightParent,"mouseleave":function($event){return _vm.handleHighlightParent(false)}}}):_vm._e(),_c('myComp',{attrs:{"html":_vm.compileContent}})],1)])])]),(_vm.editing)?_c('comment-editor',{attrs:{"configs":_vm.configs,"options":_vm.options,"replyComment":_vm.comment,"target":_vm.target,"targetId":_vm.targetId}}):_vm._e(),(_vm.comment.children)?_c('ol',{staticClass:"children-nodes"},[_vm._l((_vm.comment.children),function(children,index){return [_c('CommentNode',{key:index,attrs:{"comment":children,"configs":_vm.configs,"isChild":true,"options":_vm.options,"parent":_vm.comment,"target":_vm.target,"targetId":_vm.targetId}})]})],2):_vm._e()],1)}
var CommentNodevue_type_template_id_ed60e426_staticRenderFns = []
...
/* harmony default export */ var CommentNodevue_type_script_lang_js_ = ({
  ...
  components: {
    myComp: {
      ...
      render(h) {
        const com = external_Vue_default().extend({
          template: this.html
        });
        return h(com, {});
      }
  ...
  computed: {
    ...
    compileReference() {
      if (this.parent) {
        return `<a href="#comment-${this.parent.id}">@${this.parent.author}</a>`; // return marked.parse(`[@${this.parent.author}](#comment-${this.parent.id})`)
      }
...
var CommentNode_component = normalizeComponent(
  ...
  CommentNodevue_type_template_id_ed60e426_render,
  CommentNodevue_type_template_id_ed60e426_staticRenderFns,
  false,
  null,
  null,
  null
