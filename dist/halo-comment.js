...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".halo-comment{--main:#24292f;--color-a:#e1e8ed;--color-b:#ebeef5;--color-c:#4a4a4a;--color-d:#bfbfbf;--color-e:#333;--color-f:#909399;--color-g:#50bfff;--bg-a:hsla(0,0%,100%,.8);--bg-b:rgba(243,248,255,.8);--bg-c:rgba(237,244,253,.75);--bg-d:hsla(0,0%,100%,.8);--bg-e:hsla(210,9%,96%,.25);--bg-f:rgba(237,244,253,.75);--radius-inner:4px}.halo-comment.night{--main:#999;--color-a:#414243;--color-b:#414243;--color-c:silver;--color-d:#848484;--color-e:silver;--color-f:#777;--color-g:#276b92;--bg-a:rgba(40,39,39,.6);--bg-b:rgba(58,59,63,.5);--bg-c:rgba(65,68,74,.6);--bg-d:rgba(40,44,52,.8);--bg-e:rgba(36,36,36,.15);--bg-f:rgba(65,68,74,.6)}.halo-comment.night iframe,.halo-comment.night img,.halo-comment.night svg,.halo-comment.night video{-webkit-filter:brightness(.8);filter:brightness(.8)}blockquote,body,dd,dl,dt,fieldset,figure,h1,h2,h3,h4,h5,h6,hr,html,iframe,legend,li,ol,p,pre,textarea,ul{margin:0;padding:0}table{border-collapse:collapse;border-spacing:0}a{color:var(--theme);cursor:pointer;text-decoration:none}a:hover{color:var(--color-e)}ul{list-style:disc}.btn{cursor:pointer;font-size:.9rem;padding:6px 14px;-webkit-box-sizing:border-box;box-sizing:border-box;color:var(--main);-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;border:1px solid var(--color-a);border-radius:var(--radius-inner);background:hsla(0,0%,100%,.06)}.btn-primary{color:#fff;background:var(--theme);border-color:var(--theme)}.halo-comment{font-size:1rem;color:var(--main)}.halo-comment .avatar-body{margin-right:6px}.halo-comment .avatar{display:block;-o-object-fit:cover;object-fit:cover;border-radius:100%;width:40px;height:40px;cursor:pointer;-webkit-transition:all .8s;transition:all .8s;border:1px solid var(--color-a);padding:3px}.halo-comment .avatar:hover{border-color:var(--theme);-webkit-transform:rotate(1turn);transform:rotate(1turn)}.halo-comment .comment-editor{display:-webkit-box;display:-ms-flexbox;display:flex;margin-top:1.25rem;margin-bottom:1.25rem;-webkit-animation:top20 .5s;animation:top20 .5s}.halo-comment .comment-textarea{width:100%;margin-bottom:.5rem}.halo-comment .comment-textarea textarea{width:100%;min-height:90px}.halo-comment .emoji-picker{cursor:pointer;float:right;margin-top:.6em}.halo-comment .comment-form{-webkit-box-flex:1;-ms-flex:1 1 0px;flex:1 1 0}.halo-comment .comment-form>ul{list-style:none;margin:0;padding:0}.halo-comment .comment-form>ul li{display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex}.halo-comment .comment-form>ul li:not(:last-child){margin-right:.5rem}.halo-comment .comment-form .author-info{margin-bottom:.5rem;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:.5rem}.halo-comment .comment-form .comment-preview,.halo-comment .comment-form input,.halo-comment .comment-form textarea{-webkit-box-shadow:none;box-shadow:none;border:1px solid var(--color-a);border-radius:var(--radius-inner);background:var(--bg-a);-webkit-box-sizing:border-box;box-sizing:border-box;padding:6px 10px;resize:vertical;-webkit-transition:border-color .2s;transition:border-color .2s;color:var(--main)}.halo-comment .comment-form .comment-preview:focus,.halo-comment .comment-form input:focus,.halo-comment .comment-form textarea:focus{outline:0;border-color:var(--theme)}.halo-comment .comment-form .comment-preview.error,.halo-comment .comment-form input.error,.halo-comment .comment-form textarea.error{border-color:#f56c6c}.halo-comment .comment-form .comment-preview{min-height:90px;margin-bottom:.5rem;overflow-wrap:break-word}.halo-comment .load-comment{text-align:center;padding-bottom:16px}.halo-comment .comment-alert{margin-top:10px}.halo-comment .alert{color:#fff;padding:8px 16px;-webkit-animation:top20 .5s;animation:top20 .5s;-webkit-transition:opacity .6s;transition:opacity .6s;background-color:rgba(244,67,54,.8);border-radius:var(--radius-inner);margin-bottom:15px}.halo-comment .alert.warning{background-color:rgba(255,152,0,.8)}.halo-comment .alert.success{background-color:rgba(76,175,80,.8)}.halo-comment .alert.info{background-color:rgba(63,184,254,.8)}.halo-comment .alert .closebtn{float:right;margin-left:15px;color:#fff;font-weight:700;font-size:22px;line-height:16px;cursor:pointer;-webkit-transition:.3s;transition:.3s}.halo-comment .alert .closebtn:hover{color:var(--theme)}.halo-comment .comment-empty{margin:30px 0;text-align:center;color:var(--color-f)}.halo-comment .children-nodes,.halo-comment .comment-nodes{padding:0;margin:0}.halo-comment .comment{overflow:hidden;margin-top:10px;list-style-type:none}.halo-comment .index-1{margin-top:20px;padding-bottom:20px}.halo-comment .index-1>.children-nodes{margin-left:56px}.halo-comment .index-1:not(:last-child){border-bottom:1px solid var(--color-b)}.halo-comment .index-1>.comment-body .avatar,.halo-comment .index-1>.comment-editor .avatar{width:48px;height:48px}.halo-comment .comment-body{display:-webkit-box;display:-ms-flexbox;display:flex}.halo-comment .comment-body:hover .comment-reply{opacity:1;pointer-events:auto}.halo-comment .comment-meta .comment-author{-webkit-box-flex:1;-ms-flex:1;flex:1;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between}.halo-comment .comment-meta .author-name{font-size:1.2em;font-weight:700;color:var(--main);text-decoration:none;margin-right:5px}.halo-comment .comment-meta .author-name:hover{color:var(--theme)}.halo-comment .comment-meta .is-admin{font-size:.7em;padding:1px 4px;background:rgba(255,136,169,.3);color:#fb7299;border-radius:3px;border:1px solid #fb7299}.halo-comment .comment-meta .comment-reply{opacity:0;pointer-events:none;-webkit-transition:all .2s;transition:all .2s;padding:2px 8px}.halo-comment .comment-meta .comment-info{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-flex:1;-ms-flex:1;flex:1;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;margin-top:5px;font-size:.9em}.halo-comment .comment-meta .comment-time{color:var(--color-c)}.halo-comment .comment-meta .useragent-info{color:var(--color-d)}.halo-comment .comment-main{-webkit-box-flex:1;-ms-flex:1 1 0px;flex:1 1 0}.halo-comment .comment-main .markdown-content{padding:10px;margin-top:5px;background:var(--bg-b);border-radius:0 8px 8px 8px}@media(max-width:768px){.halo-comment .author-info{grid-template-columns:auto!important}.halo-comment .comment-meta .comment-reply{opacity:1;pointer-events:auto}}@-webkit-keyframes top20{0%{opacity:0;-webkit-transform:translateY(-20px);transform:translateY(-20px)}to{opacity:1;-webkit-transform:translateY(0);transform:translateY(0)}}@keyframes top20{0%{opacity:0;-webkit-transform:translateY(-20px);transform:translateY(-20px)}to{opacity:1;-webkit-transform:translateY(0);transform:translateY(0)}}.markdown-content{padding:10px;background:#f5f5f5;border-radius:0 8px 8px 8px}.markdown-content>:first-child{margin-top:0}.markdown-content>:last-child{margin-bottom:0}.markdown-content>span.comment-reference:first-child{margin-right:6px}.markdown-content>span.comment-reference:first-child+p{display:inline}.markdown-content p{line-height:1.5em;margin-bottom:14px}.markdown-content h1,.markdown-content h2,.markdown-content h3,.markdown-content h4,.markdown-content h5,.markdown-content h6{color:var(--color-e);margin-bottom:14px}.markdown-content h1,.markdown-content h2{padding-bottom:.2em;border-bottom:1px solid var(--color-b)}.markdown-content h1{margin:28px 0 18px 0;font-size:1.45em}.markdown-content h2{margin:24px 0 16px 0;font-size:1.25em}.markdown-content h3{margin:20px 0 15px 0;font-size:1.2em}.markdown-content h4{font-size:1.15em}.markdown-content h5,.markdown-content h6{font-size:1em}.markdown-content img:not([class]){max-width:100%;-webkit-transition:all .35s;transition:all .35s;margin:5px 0;border-radius:5px}.markdown-content img:not([class]):hover{-webkit-box-shadow:0 34px 20px -24px rgba(136,161,206,.3);box-shadow:0 34px 20px -24px rgba(136,161,206,.3)}.markdown-content a:not([class]){line-height:1.5em;color:var(--theme);background-image:linear-gradient(transparent calc(100% - 1px),var(--theme) 1px);background-repeat:no-repeat;background-size:0 100%;-webkit-transition:all .35s ease-in-out;transition:all .35s ease-in-out}.markdown-content a:not([class]):hover{color:var(--theme);background-size:100% 100%}.markdown-content ol,.markdown-content ul{margin-bottom:14px;padding-left:30px}.markdown-content ol li,.markdown-content ul li{line-height:1.5em}.markdown-content ol li.task-list-item,.markdown-content ul li.task-list-item{list-style:none;margin-left:-26px}.markdown-content table{width:100%;max-width:100%;table-layout:fixed;border-collapse:unset;color:var(--main);background:var(--bg-d);margin-bottom:14px;overflow:hidden;font-size:.95em;border:1px solid var(--color-b);border-radius:var(--radius-inner)}.markdown-content table td,.markdown-content table th{padding:8px;border-right:1px solid var(--color-b);border-bottom:1px solid var(--color-b)}.markdown-content table thead th{font-weight:500;background:var(--bg-c)}.markdown-content table thead th:last-child{border-right:none}.markdown-content table tbody tr{-webkit-transition:background .35s;transition:background .35s}.markdown-content table tbody tr:nth-child(2n){background:var(--bg-e)}.markdown-content table tbody tr:last-child td{border-bottom:none}.markdown-content table tbody tr:hover{background:hsla(0,0%,70%,.15)}.markdown-content table tbody tr td:last-child{border-right:none}.markdown-content pre{padding:16px;overflow:auto;font-size:85%;line-height:1.45;margin-bottom:14px;background-color:var(--bg-a);border-radius:6px}.markdown-content :not(pre)>code{font-size:.9em;color:var(--color-c);margin:0 2px;padding:4px 8px;white-space:normal;vertical-align:baseline;word-break:break-word;background:rgba(175,184,193,.2);border-radius:var(--radius-inner)}.markdown-content blockquote{line-height:1.5em;margin-bottom:14px;padding:8px 15px;color:var(--color-f);background:var(--bg-f);border-left:5px solid var(--color-g);border-radius:var(--radius-inner)}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".comment-page{margin-top:30px;text-align:center;border-top:2px solid var(--bg-b)}.comment-page .page{display:inline-block;padding:10px 0;margin:0}.comment-page .page li{display:inline;margin-right:5px}.comment-page .page button{margin-bottom:8px;position:relative;font-size:inherit;font-family:inherit;padding:5px 10px;border:1px solid var(--color-a);border-radius:4px;cursor:pointer;-webkit-transition:all .8s;transition:all .8s;font-weight:400;color:var(--color-f);background-color:var(--bg-a)}.comment-page .page .active,.comment-page .page button:hover{color:var(--theme);border-color:var(--theme)}", ""]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/Comment.vue?vue&type=template&id=504d884c&shadow
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"halo-comment",class:_vm.mergedConfigs.night ? 'night' : '',attrs:{"id":"halo-comment"}},[_c('comment-editor',{attrs:{"configs":_vm.mergedConfigs,"options":_vm.options,"target":_vm.target,"targetId":_vm.id}}),(!_vm.mergedConfigs.autoLoad && !_vm.list.loaded)?_c('div',{staticClass:"load-comment"},[_c('button',{staticClass:"btn btn-primary",attrs:{"type":"button"},on:{"click":_vm.handleGetComments}},[_vm._v("加载评论")])]):_vm._e(),_c('comment-loading',{directives:[{name:"show",rawName:"v-show",value:(_vm.list.loading),expression:"list.loading"}],attrs:{"configs":_vm.configs}}),(_vm.list.data.length >= 1)?_c('ul',{staticClass:"comment-nodes"},[_vm._l((_vm.list.data),function(comment){return [_c('CommentNode',{key:comment.id,attrs:{"comment":comment,"configs":_vm.mergedConfigs,"options":_vm.options,"target":_vm.target,"targetId":_vm.id}})]})],2):_vm._e(),(_vm.list.loaded && !_vm.list.loading && _vm.list.data.length <= 0)?_c('div',{staticClass:"comment-empty"},[_vm._v("暂无评论")]):_vm._e(),(_vm.list.pages > 1)?_c('pagination',{attrs:{"page":_vm.list.params.page,"size":_vm.list.size,"total":_vm.list.total},on:{"change":_vm.handlePaginationChange}}):_vm._e()],1)}
var staticRenderFns = []
...
var component = normalizeComponent(
  ...
  CommentEditorvue_type_template_id_31f9f5ac_render,
  CommentEditorvue_type_template_id_31f9f5ac_staticRenderFns,
  false,
  null,
  null,
  null
...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/CommentNode.vue?vue&type=template&id=14214b65&
var CommentNodevue_type_template_id_14214b65_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('li',{staticClass:"comment",class:_vm.commentClass,attrs:{"id":'li-comment-' + _vm.comment.id,"itemprop":"comment","itemtype":"https://schema.org/Comment"}},[_c('div',{ref:'comment-' + _vm.comment.id,staticClass:"comment-body",attrs:{"id":'comment-' + _vm.comment.id}},[_c('div',{staticClass:"avatar-body"},[_c('a',{attrs:{"href":("" + (_vm.comment.authorUrl ? _vm.comment.authorUrl : 'javascript:void(0)')),"rel":"nofollow","target":"_blank"}},[_c('img',{staticClass:"avatar",attrs:{"alt":_vm.comment.author + "'s avatar","src":_vm.avatar}})])]),_c('div',{staticClass:"comment-main"},[_c('div',{staticClass:"comment-meta"},[_c('div',{staticClass:"comment-author",attrs:{"itemprop":"author"}},[_c('div',{staticClass:"author-info"},[_c('a',{staticClass:"author-name",attrs:{"href":_vm.comment.authorUrl,"rel":"nofollow","target":"_blank"}},[_vm._v(_vm._s(_vm.comment.author))]),(_vm.comment.isAdmin)?_c('span',{staticClass:"is-admin"},[_vm._v("博主")]):_vm._e()]),_c('span',{staticClass:"btn btn-primary comment-reply",on:{"click":function($event){_vm.globalData.replyId = _vm.globalData.replyId === _vm.comment.id ? 0 : _vm.comment.id}}},[_vm._v(_vm._s(_vm.globalData.replyId === _vm.comment.id ? '取消回复' : '回复'))])]),_c('div',{staticClass:"comment-info"},[_c('time',{staticClass:"comment-time",attrs:{"datetime":_vm.comment.createTime,"itemprop":"datePublished"}},[_vm._v(_vm._s(_vm.createTimeAgo))]),(_vm.configs.showUserAgent)?_c('div',{staticClass:"useragent-info"},[_vm._v(" "+_vm._s(_vm.compileUserAgent)+" ")]):_vm._e()])]),_c('div',{ref:"comment",staticClass:"markdown-content",attrs:{"itemprop":"description"}},[(_vm.parent)?_c('span',{staticClass:"comment-reference",on:{"mouseenter":_vm.handleHighlightParent,"mouseleave":function($event){return _vm.handleHighlightParent(false)}}},[_c('a',{attrs:{"href":'#comment-' + this.parent.id}},[_vm._v("@"+_vm._s(this.parent.author))])]):_vm._e()])])]),(_vm.globalData.replyId === _vm.comment.id)?_c('comment-editor',{attrs:{"configs":_vm.configs,"options":_vm.options,"replyComment":_vm.comment,"target":_vm.target,"targetId":_vm.targetId}}):_vm._e(),(_vm.comment.children)?_c('ul',{staticClass:"children-nodes"},[_vm._l((_vm.comment.children),function(children,index){return [_c('CommentNode',{key:index,attrs:{"comment":children,"configs":_vm.configs,"isChild":true,"options":_vm.options,"parent":_vm.comment,"target":_vm.target,"targetId":_vm.targetId}})]})],2):_vm._e()],1)}
var CommentNodevue_type_template_id_14214b65_staticRenderFns = []
...
var CommentNode_component = normalizeComponent(
  ...
  CommentNodevue_type_template_id_14214b65_render,
  CommentNodevue_type_template_id_14214b65_staticRenderFns,
  false,
  null,
  null,
  null
...
var Pagination_component = normalizeComponent(
  ...
  Paginationvue_type_template_id_1f7d52a4_render,
  Paginationvue_type_template_id_1f7d52a4_staticRenderFns,
  false,
