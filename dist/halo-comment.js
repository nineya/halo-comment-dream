...
var component = normalizeComponent(
  ...
  CommentEditorvue_type_template_id_89f59c96_render,
  CommentEditorvue_type_template_id_89f59c96_staticRenderFns,
  false,
  null,
  null,
  null
...
const CommentNodevue_type_script_lang_js_rendererMD = new marked.Renderer();

CommentNodevue_type_script_lang_js_rendererMD.listitem = function (text, task) {
  return `<li${task ? ' class="task-list-item"' : ''}>${text}</li>`;
};
  ...
  created: function () {
    this.$nextTick(function () {
      ...
      tempNode.innerHTML = marked.parse(this.comment.content, {
        renderer: CommentNodevue_type_script_lang_js_rendererMD
      });
...
var CommentNode_component = normalizeComponent(
  ...
  CommentNodevue_type_template_id_a87c76ac_render,
  CommentNodevue_type_template_id_a87c76ac_staticRenderFns,
  false,
  null,
  null,
  null
