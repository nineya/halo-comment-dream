...
if (typeof window !== 'undefined') {
  ...
  if (({"NODE_ENV":"production","BASE_URL":"/themes/dream/source/lib/halo-comment@1.0.0/"}).NEED_CURRENTSCRIPT_POLYFILL) {
...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/dreamEmoji/EmojiPicker.vue?vue&type=template&id=2d0eb79c&
var EmojiPickervue_type_template_id_2d0eb79c_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('EmojiList',{attrs:{"data":_vm.pack},on:{"select":_vm.onSelectEmoji}})}
var EmojiPickervue_type_template_id_2d0eb79c_staticRenderFns = []


;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/dreamEmoji/EmojiList.vue?vue&type=template&id=0a71ee49&
var EmojiListvue_type_template_id_0a71ee49_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"motion-container",attrs:{"id":"container-emoji"}},_vm._l((_vm.data),function(emoji,index){return _c('DreamEmoji',{key:index,attrs:{"data":emoji},nativeOn:{"click":function($event){return _vm.onSelect(emoji)}}})}),1)}
var EmojiListvue_type_template_id_0a71ee49_staticRenderFns = []
...
/* harmony default export */ var DreamEmojivue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    url: {
      type: String,
      required: false,
      default: `${"/themes/dream/source/lib/halo-comment@1.0.0/"}assets/emoji/`
    }
  },
  computed: {
    dreamSrc() {
...
var EmojiList_component = normalizeComponent(
  ...
  EmojiListvue_type_template_id_0a71ee49_render,
  EmojiListvue_type_template_id_0a71ee49_staticRenderFns,
  false,
  null,
  null,
  null
...
var EmojiPicker_component = normalizeComponent(
  ...
  EmojiPickervue_type_template_id_2d0eb79c_render,
  EmojiPickervue_type_template_id_2d0eb79c_staticRenderFns,
  false,
  null,
  null,
  null
...
;// CONCATENATED MODULE: ./src/components/dreamEmoji/emojis.js
class Emoji {
...
const defaultEmoji = [new Emoji('hehe', '呵呵'), new Emoji('haha', '哈哈'), new Emoji('tushe', '吐舌'), new Emoji('a', '啊'), new Emoji('ku', '酷'), new Emoji('nu', '怒'), new Emoji('kaixin', '开心'), new Emoji('han', '汗'), new Emoji('lei', '泪'), new Emoji('heixian', '黑线'), new Emoji('bishi', '鄙视'), new Emoji('bugaoxing', '不高兴'), new Emoji('zhenbang', '真棒'), new Emoji('qian', '钱'), new Emoji('yiwen', '疑问'), new Emoji('yingxiang', '阴险'), new Emoji('tu', '吐'), new Emoji('yi', '咦'), new Emoji('weiqu', '委屈'), new Emoji('huaxin', '花心'), new Emoji('hu', '呼~'), new Emoji('xiaoyan', '笑眼'), new Emoji('len', '冷'), new Emoji('taikaixin', '太开心'), new Emoji('huaji', '滑稽'), new Emoji('mianqiang', '勉强'), new Emoji('kuanhan', '狂汗'), new Emoji('guai', '乖'), new Emoji('shuijiao', '睡觉'), new Emoji('jingku', '惊哭'), new Emoji('shengqi', '生气'), new Emoji('jingya', '惊讶'), new Emoji('pen', '喷'), new Emoji('haha', '哈哈'), new Emoji('haha', '哈哈'), new Emoji('haha', '哈哈'), new Emoji('haha', '哈哈')];
/* harmony default export */ var emojis = ([...defaultEmoji]);
...
var CommentEditor_component = normalizeComponent(
  ...
  CommentEditorvue_type_template_id_121f59d4_render,
  CommentEditorvue_type_template_id_121f59d4_staticRenderFns,
  false,
  null,
  null,
  null
...
var CommentNode_component = normalizeComponent(
  ...
  CommentNodevue_type_template_id_025e8d9f_render,
  CommentNodevue_type_template_id_025e8d9f_staticRenderFns,
  false,
  null,
  null,
  null
