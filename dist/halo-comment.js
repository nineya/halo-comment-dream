...
;// CONCATENATED MODULE: ./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/Comment.vue?vue&type=template&id=d9549a06&shadow
...
function renderedEmojiHtml(html) {
  ...
  for (let emoji of emojiData) {
    let name = emoji.name;
    let img = `<img class="dream-emoji" src="${"/themes/dream/source/lib/halo-comment@1.0.6/"}assets/emoji/${emoji.fileName}.png" alt="${name}"/>`;
...
/* harmony default export */ var Commentvue_type_script_lang_js_shadow = ({
  ...
  methods: {
    ...
    flatReplyList(comments) {
      console.log(this.mergedConfigs);
